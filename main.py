...
def webhook():
    ...
    if payload.get("object_kind") == "merge_request":
        ...
        # get from diffs all filenames (and path) and store them in a list




        pre_prompt = "Review the git diff of a recent commit, focusing on clarity, structure, tests, standard compliance and security. Ensure to assess how the changes impact the overall project."
